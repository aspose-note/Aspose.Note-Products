---
title: 通过 C# 将 ONETOC2 转换为 PDF 
url: /zh/net/conversion/onetoc2-to-pdf/ 
description: ONETOC2 到 PDF C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 ONETOC2 文件批量转换为 PDF。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 ONETOC2 转换为 PDF" h2="将 Onetoc2Note® ONETOC2 导出到 .NET Framework、.NET Core 上的 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 ONETOC2 转换为 PDF" %}}

为了将 ONETOC2 转换为 PDF，我们将使用 <a href=https://products.aspose.com/note/net>Aspose.Note for .NET</a> API，这是一个功能丰富、功能强大且易于使用的用于 C# 平台的文档操作和转换 API。打开 <a href=https://www.nuget.org/packages/aspose.note>NuGet</a> 包管理器，搜索 <b>Aspose.Note</b> 并安装。您也可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 ONETOC2 转换为 PDF 的步骤" %}}
...
1.调用Document.Save方法
1. 传递输出文件路径 & SaveFormat.Pdf 作为参数
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 ONETOC2 到 PDF C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 ONETOC2 转换为 PDF 的免费应用程序" sectionDescription="Check our live demos for [ONETOC2 to PDF conversion](https://products.aspose.app/note/conversion/onetoc2-to-pdf) with following benefits." >}}
