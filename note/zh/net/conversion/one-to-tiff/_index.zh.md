---
title: 通过 C# 将 ONE 转换为 TIFF 
url: /zh/net/conversion/one-to-tiff/ 
description: ONE 到 TIFF C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 ONE 文件批量转换为 TIFF。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 ONE 转换为 TIFF" h2="将 OneNote® ONE 导出到 .NET Framework、.NET Core 上的 TIFF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 ONE 转换为 TIFF" %}}

为了将 ONE 转换为 TIFF，我们将使用 <a href=https://products.aspose.com/note/net>Aspose.Note for .NET</a> API，这是一个功能丰富、功能强大且易于使用的用于 C# 平台的文档操作和转换 API。打开 <a href=https://www.nuget.org/packages/aspose.note>NuGet</a> 包管理器，搜索 <b>Aspose.Note</b> 并安装。您也可以从包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 ONE 转换为 TIFF 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 ONE 到 TIFF C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 ONE 转换为 TIFF 的免费应用程序" sectionDescription="Check our live demos for [ONE to TIFF conversion](https://products.aspose.app/note/conversion/one-to-tiff) with following benefits." >}}
