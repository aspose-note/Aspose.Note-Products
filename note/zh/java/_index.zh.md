...
<p class="col-lg-10">从 OneNote 文件中提取图像</p>
...
<p class="col-lg-10">Note 文档的默认字体</p>
...
<h2 class="h2title">Microsoft Office OneNote 自动化 - 不需要</h2>

<p>Aspose.Note for Java 使用托管代码构建，无需在计算机上安装 Microsoft Office 或 Microsoft OneNote 即可使用 OneNote 文件。在支持的功能、安全性、稳定性、可扩展性、速度和价格方面，它是一个完美的 Microsoft OneNote 自动化替代方案。</p>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 Aspose.Note for Java？" tabId="success-stories" >}}
