...
<p class="col-lg-10">Извлечение изображений из файлов OneNote</p>
...
<p class="col-lg-10">Шрифт по умолчанию для документов Note</p>
...
<h2 class="h2title">Автоматизация Microsoft Office OneNote — не требуется</h2>

<p>Aspose.Note для Java построен с использованием управляемого кода, который не требует установки Microsoft Office или Microsoft OneNote на компьютере для работы с файлами OneNote. Это идеальная альтернатива автоматизации Microsoft OneNote с точки зрения поддерживаемых функций, безопасности, стабильности, масштабируемости, скорости и цены.</p>
