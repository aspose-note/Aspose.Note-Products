...
1. आउटपुट फ़ाइल पथ और SaveFormat.Pdf को पैरामीटर के रूप में पास करें
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="एक को बीएमपी में बदलने के लिए मुफ्त ऐप" sectionDescription="Check our live demos for [ONETOC2 to PDF conversion](https://products.aspose.app/note/conversion/onetoc2-to-pdf) with following benefits." >}}
