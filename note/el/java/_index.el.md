...
<p class="col-lg-10">Εξαγωγή εικόνων από αρχεία OneNote</p>
...
<p class="col-lg-10">Προεπιλεγμένη γραμματοσειρά για έγγραφα σημειώσεων</p>
...
<h2 class="h2title">Microsoft Office OneNote Automation - Δεν απαιτείται</h2>

<p>Το Aspose.Note για Java έχει δημιουργηθεί χρησιμοποιώντας διαχειριζόμενο κώδικα που δεν χρειάζεται το Microsoft Office ή το Microsoft OneNote να εγκατασταθεί στο μηχάνημα για να λειτουργήσει με αρχεία OneNote. Είναι μια τέλεια εναλλακτική λύση αυτοματισμού Microsoft OneNote όσον αφορά τις υποστηριζόμενες δυνατότητες, την ασφάλεια, τη σταθερότητα, την επεκτασιμότητα, την ταχύτητα και την τιμή.</p>
