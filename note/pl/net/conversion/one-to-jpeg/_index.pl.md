---
title: Konwertuj ONE na JPEG za pomocą C# 
url: /pl/net/conversion/one-to-jpeg/ 
description: Przykładowy kod konwersji ONE na JPEG C#. Użyj przykładowego kodu API dla plików wsadowych ONE do konwersji JPEG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ONE na JPEG za pomocą C#" h2="Eksportuj OneNote® ONE do JPEG na .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ONE na JPEG za pomocą C#" %}}
...
1. Przekaż ścieżkę pliku wyjściowego i SaveFormat.Jpeg jako parametry
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ONE do JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ONE na JPEG" sectionDescription="Check our live demos for [ONE to JPEG conversion](https://products.aspose.app/note/conversion/one-to-jpeg) with following benefits." >}}
