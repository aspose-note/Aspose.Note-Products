---
title: Konwertuj ONETOC2 na PNG za pomocą C# 
url: /pl/net/conversion/onetoc2-to-png/ 
description: Przykładowy kod konwersji ONETOC2 na PNG C#. Użyj przykładowego kodu API dla plików wsadowych ONETOC2 do konwersji PNG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ONETOC2 na PNG za pomocą C#" h2="Eksportuj Onetoc2Note® ONETOC2 do PNG na .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ONETOC2 na PNG za pomocą C#" %}}
...
1. Przekaż ścieżkę pliku wyjściowego i SaveFormat.Png jako parametry
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ONETOC2 do PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ONETOC2 na PNG" sectionDescription="Check our live demos for [ONETOC2 to PNG conversion](https://products.aspose.app/note/conversion/onetoc2-to-png) with following benefits." >}}
