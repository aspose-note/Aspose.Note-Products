---
title: Konwertuj ONE na PDF za pomocą C# 
url: /pl/net/conversion/one-to-pdf/ 
description: Przykładowy kod konwersji ONE na PDF C#. Użyj przykładowego kodu API dla plików wsadowych ONE do konwersji PDF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ONE na PDF za pomocą C#" h2="Eksportuj OneNote® ONE do PDF na .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ONE na PDF za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ONE do PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ONE na PDF" sectionDescription="Check our live demos for [ONE to PDF conversion](https://products.aspose.app/note/conversion/one-to-pdf) with following benefits." >}}
