---
title: Konwertuj ONE na PNG za pomocą C# 
url: /pl/net/conversion/one-to-png/ 
description: Przykładowy kod konwersji ONE na PNG C#. Użyj przykładowego kodu API dla plików wsadowych ONE do konwersji PNG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ONE na PNG za pomocą C#" h2="Eksportuj OneNote® ONE do PNG na .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ONE na PNG za pomocą C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ONE do PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ONE na PNG" sectionDescription="Check our live demos for [ONE to PNG conversion](https://products.aspose.app/note/conversion/one-to-png) with following benefits." >}}
