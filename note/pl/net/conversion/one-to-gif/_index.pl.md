---
title: Konwertuj ONE na GIF za pomocą C# 
url: /pl/net/conversion/one-to-gif/ 
description: Przykładowy kod konwersji ONE na GIF C#. Użyj przykładowego kodu API dla plików wsadowych ONE do konwersji GIF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ONE na GIF za pomocą C#" h2="Eksportuj OneNote® ONE do GIF na .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ONE na GIF za pomocą C#" %}}
...
1. Przekaż ścieżkę pliku wyjściowego i SaveFormat.Gif jako parametry
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję ONE do GIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ONE na GIF" sectionDescription="Check our live demos for [ONE to GIF conversion](https://products.aspose.app/note/conversion/one-to-gif) with following benefits." >}}
