---
title: Convertir ONE en TIFF via Java
description: Exemple de code pour la conversion Java ONE vers TIFF. Utilisez le code d'exemple d'API pour la conversion des fichiers batch ONE en TIFF dans n'importe quelle application basée sur Java. 
url: /fr/java/conversion/one-to-tiff/
family: note
platformtag: java
feature: conversion
informat: ONE
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir ONE en TIFF via Java" h2="Exportez OneNote<sup>&reg;</sup> ONE vers une image TIFF dans des applications basées sur Java sans dépendre d'aucun autre logiciel." >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Note pour Java](https://products.aspose.com/note/java/) est une API pour traiter, afficher ou convertir des fichiers Microsoft OneNote aux formats d'image PDF, JPG, PNG, TIFF et TIFF. Il s'agit d'une API d'application autonome, conviviale et rapide qui ne nécessite aucun logiciel supplémentaire. Il prend en charge les extensions .one et .onenote avec une conversion haute performance.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ONE en TIFF" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre comment convertir ONE en image TIFF via Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ONE en TIFF" sectionDescription="[Convert OneNote file](https://products.aspose.app/note/conversion/onenote-to-tiff) right now by visiting our Live Demos website." >}}
