---
title: Convertir ONETOC2 en PDF via Java
description: Exemple de code pour la conversion Java ONETOC2 vers PDF. Utilisez le code d'exemple d'API pour la conversion des fichiers batch ONETOC2 en PDF dans n'importe quelle application basée sur Java. 
url: /fr/java/conversion/onetoc2-to-pdf/
family: note
platformtag: java
feature: conversion
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir ONETOC2 en PDF via Java" h2="Exportez Onetoc2Note<sup>&reg;</sup> ONETOC2 vers une image PDF dans des applications basées sur Java sans dépendre d'aucun autre logiciel." >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Note pour Java](https://products.aspose.com/note/java/) est une API pour traiter, afficher ou convertir des fichiers Microsoft Onetoc2Note aux formats d'image PDF, JPG, PNG, PDF et TIFF. Il s'agit d'une API d'application autonome, conviviale et rapide qui ne nécessite aucun logiciel supplémentaire. Il prend en charge les extensions .onetoc2 et .onetoc2note avec une conversion haute performance.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ONETOC2 en PDF" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre comment convertir ONETOC2 en image PDF via Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ONETOC2 en PDF" sectionDescription="[Convert Onetoc2Note file](https://products.aspose.app/note/conversion/onetoc2note-to-pdf) right now by visiting our Live Demos website." >}}
