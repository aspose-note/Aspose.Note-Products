---
title: API .NET et Java OneNote | Traitement des documents OneNote 
weight: 10
url: /fr/family
description: Lire créer manipuler enregistrer des fichiers Microsoft Office OneNote à l'aide de la bibliothèque appropriée sur n'importe quelle plate-forme. Exporter des documents .one aux formats PDF BMP PNG JPEG GIF
---
...
{{< blocks/products/pf/product pfName="Aspose.Note for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" productLink="/note/fr/net/" >}}
Ciblez Windows Forms, ASP.NET, WPF, WCF ou tout type d'application basée sur .NET Framework 2.0 ou version ultérieure.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Note for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-java.svg" productLink="/note/fr/java/" >}}
...
{{< blocks/products/pf/slr-element name="Code source" href="https://github.com/aspose-note?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi la famille de produits Aspose.Note ?" tabId="success-stories" >}}
