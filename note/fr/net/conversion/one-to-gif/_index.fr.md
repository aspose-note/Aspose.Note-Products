---
title: Convertir ONE en GIF via C# 
url: /fr/net/conversion/one-to-gif/ 
description: Exemple de code pour la conversion ONE vers GIF C#. Utilisez le code d'exemple d'API pour les fichiers batch ONE en conversion GIF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ONE en GIF via C#" h2="Exportez OneNote® ONE vers GIF sur .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ONE en GIF via C #" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion ONE vers GIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ONE en GIF" sectionDescription="Check our live demos for [ONE to GIF conversion](https://products.aspose.app/note/conversion/one-to-gif) with following benefits." >}}
