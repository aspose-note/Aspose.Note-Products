...
{{< blocks/products/pf/i18n/upper-banner h1="Các API xử lý tài liệu .NET OneNote" h2="Tạo, thao tác và chuyển đổi tệp OneNote sang nhiều định dạng mà không có bất kỳ phụ thuộc Microsoft OneNote nào." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/headers/aspose_note-for-net.svg" pfName="Aspose.Note" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/note/net" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Thao tác với các siêu liên kết trong các phần tử văn bản và hình ảnh
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
