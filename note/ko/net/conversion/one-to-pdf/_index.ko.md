---
title: C#을 통해 ONE을 PDF로 변환 
url: /ko/net/conversion/one-to-pdf/ 
description: ONE에서 PDF C#으로의 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 ONE 파일을 PDF로 변환하는 API 예제 코드를 사용합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 ONE을 PDF로 변환" h2="OneNote® ONE을 .NET Framework, .NET Core의 PDF로 내보냅니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 ONE을 PDF로 변환하는 방법" %}}

ONE을 PDF로 변환하기 위해 우리는 기능이 풍부하고 강력하며 <a href=https://products.aspose.com/note/net>Aspose.Note for .NET</a> API를 사용하기 쉬운 C# 플랫폼용 문서 조작 및 변환 API. <a href=https://www.nuget.org/packages/aspose.note>NuGet</a> 패키지 관리자를 열고 <b>Aspose.Note</b>를 검색하여 설치합니다. 패키지 관리자 콘솔에서 다음 명령을 사용할 수도 있습니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 ONE을 PDF로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 ONE에서 PDF C#으로의 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="ONE을 PDF로 변환하는 무료 앱" sectionDescription="Check our live demos for [ONE to PDF conversion](https://products.aspose.app/note/conversion/one-to-pdf) with following benefits." >}}
