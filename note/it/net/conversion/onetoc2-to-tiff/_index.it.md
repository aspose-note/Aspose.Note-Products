---
title: Converti ONETOC2 in TIFF tramite C# 
url: /it/net/conversion/onetoc2-to-tiff/ 
description: Codice di esempio per la conversionetoc2 da ONETOC2 a TIFF C#. Utilizzare il codice di esempio API per la conversionetoc2 di file batch ONETOC2 in TIFF all'interno di VB.NET, Asp.NET o qualsiasi applicazionetoc2 basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ONETOC2 in TIFF tramite C#" h2="Esporta Onetoc2Note® ONETOC2 in TIFF su .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire ONETOC2 in TIFF tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversionetoc2 da ONETOC2 a TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire ONETOC2 in TIFF" sectionDescription="Check our live demos for [ONETOC2 to TIFF conversion](https://products.aspose.app/note/conversion/onetoc2-to-tiff) with following benefits." >}}
