---
title: Converti ONE in GIF tramite C# 
url: /it/net/conversion/one-to-gif/ 
description: Codice di esempio per la conversione da ONE a GIF C#. Utilizzare il codice di esempio API per la conversione di file batch ONE in GIF all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti ONE in GIF tramite C#" h2="Esporta OneNote® ONE in GIF su .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire ONE in GIF tramite C#" %}}
...
1. Passa il percorso del file di output e SaveFormat.Gif come parametri
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da ONE a GIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire ONE in GIF" sectionDescription="Check our live demos for [ONE to GIF conversion](https://products.aspose.app/note/conversion/one-to-gif) with following benefits." >}}
