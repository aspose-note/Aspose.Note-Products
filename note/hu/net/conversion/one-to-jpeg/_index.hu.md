---
title: ONE konvertálása JPEG-re C#-on keresztül 
url: /hu/net/conversion/one-to-jpeg/ 
description: Mintakód a ONE-ból JPEG-be C# konvertáláshoz. Használjon API-példakódot a VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belüli kötegelt ONE fájlok JPEG-vé konvertálásához.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ONE konvertálása JPEG-re C#-on keresztül" h2="Exportálja a OneNote® ONE-t JPEG-be .NET-keretrendszeren, .NET Core-on." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ONE konvertálásához JPEG-vé C# segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ONE-JPEG C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás az ONE konvertálásához JPEG-vé" sectionDescription="Check our live demos for [ONE to JPEG conversion](https://products.aspose.app/note/conversion/one-to-jpeg) with following benefits." >}}
