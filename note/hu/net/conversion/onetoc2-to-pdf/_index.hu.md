---
title: ONETOC2 konvertálása PDF-re C#-on keresztül 
url: /hu/net/conversion/onetoc2-to-pdf/ 
description: Mintakód a ONETOC2-ból PDF-be C# konvertáláshoz. Használjon API-példakódot a VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belüli kötegelt ONETOC2 fájlok PDF-vé konvertálásához.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ONETOC2 konvertálása PDF-re C#-on keresztül" h2="Exportálja a Onetoc2Note® ONETOC2-t PDF-be .NET-keretrendszeren, .NET Core-on." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ONETOC2 konvertálásához PDF-vé C# segítségével" %}}
...
1. Adja meg a kimeneti fájl elérési útját és a SaveFormat.Pdf paramétert
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ONETOC2-PDF C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás az ONETOC2 konvertálásához PDF-vé" sectionDescription="Check our live demos for [ONETOC2 to PDF conversion](https://products.aspose.app/note/conversion/onetoc2-to-pdf) with following benefits." >}}
