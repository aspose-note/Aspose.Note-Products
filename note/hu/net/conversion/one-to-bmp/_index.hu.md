---
title: ONE konvertálása BMP-re C#-on keresztül 
url: /hu/net/conversion/one-to-bmp/ 
description: Mintakód a ONE-ból BMP-be C# konvertáláshoz. Használjon API-példakódot a VB.NET-en, Asp.NET-en vagy bármely .NET-alapú alkalmazáson belüli kötegelt ONE fájlok BMP-vé konvertálásához.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="ONE konvertálása BMP-re C#-on keresztül" h2="Exportálja a OneNote® ONE-t BMP-be .NET-keretrendszeren, .NET Core-on." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a ONE konvertálásához BMP-vé C# segítségével" %}}
...
1. Adja meg a kimeneti fájl elérési útját és a SaveFormat.Bmp paramétert
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód az ONE-BMP C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás az ONE konvertálásához BMP-vé" sectionDescription="Check our live demos for [ONE to BMP conversion](https://products.aspose.app/note/conversion/one-to-bmp) with following benefits." >}}
