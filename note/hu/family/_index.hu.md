---
title: .NET és Java OneNote API | OneNote dokumentumfeldolgozás 
weight: 10
url: /hu/family
description: Olvassa el a Microsoft Office OneNote-fájlok létrehozásának kezelését és mentését a megfelelő könyvtár használatával bármilyen platformon. Exportáljon .one dokumentumokat PDF BMP PNG JPEG GIF formátumba
---
...
{{< blocks/products/pf/product pfName="Aspose.Note for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" productLink="/note/hu/net/" >}}
...
{{< blocks/products/pf/product pfName="Aspose.Note for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-java.svg" productLink="/note/hu/java/" >}}
...
{{< blocks/products/pf/slr-element name="Dokumentáció" href="https://docs.aspose.com/note/" >}}
{{< blocks/products/pf/slr-element name="Forráskód" href="https://github.com/aspose-note?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért az Aspose.Note termékcsalád?" tabId="success-stories" >}}
