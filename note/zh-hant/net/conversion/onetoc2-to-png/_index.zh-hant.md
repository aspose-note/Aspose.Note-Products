---
title: 通過 C# 將 ONETOC2 轉換為 PNG 
url: /zh-hant/net/conversion/onetoc2-to-png/ 
description: ONETOC2 到 PNG C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 ONETOC2 文件批量轉換為 PNG。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 ONETOC2 轉換為 PNG" h2="將 Onetoc2Note® ONETOC2 導出到 .NET Framework、.NET Core 上的 PNG。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 ONETOC2 轉換為 PNG" %}}

為了將 ONETOC2 轉換為 PNG，我們將使用 <a href=https://products.aspose.com/note/net>Aspose.Note for .NET</a> API，這是一個功能豐富、功能強大且易於使用的用於 C# 平台的文檔操作和轉換 API。打開 <a href=https://www.nuget.org/packages/aspose.note>NuGet</a> 包管理器，搜索 <b>Aspose.Note</b> 並安裝。您還可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 ONETOC2 轉換為 PNG 的步驟" %}}
...
1.調用Document.Save方法
1. 傳遞輸出文件路徑 & SaveFormat.Png 作為參數
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 ONETOC2 到 PNG C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 ONETOC2 轉換為 PNG 的免費應用程序" sectionDescription="Check our live demos for [ONETOC2 to PNG conversion](https://products.aspose.app/note/conversion/onetoc2-to-png) with following benefits." >}}
