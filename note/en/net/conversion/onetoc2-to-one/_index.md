---
title: Convert ONETOC2 to ONE via C# 
url: /net/conversion/onetoc2-to-one/ 
description: Sample code for ONETOC2 to ONE C# conversion. Use API example code for batch ONETOC2 files to ONE conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ONETOC2 to ONE via C#" h2="Export OneNote® ONETOC2 to ONE on .NET Framework, .NET Core." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ONE" pfName="Aspose.NOTE" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="NOTE" fileiconsmall4="XML" fileiconsmall5="ONETOC2" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ONETOC2 to ONE Using C#" %}}

In order to convert ONETOC2 to ONE, we’ll use <a href="https://products.aspose.com/note/net">Aspose.Note for .NET</a> API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open <a href="https://www.nuget.org/packages/aspose.note">NuGet</a> package manager, search for <b>Aspose.Note</b> and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ONETOC2 to ONE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.NOTE makes it easy for the developers to load & convert ONETOC2 files to ONE in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1. Load ONETOC2 file with Document class
1. Call the Document.Save method
1. Pass output file path & SaveFormat.One as parameters
...
{{% blocks/products/pf/agp/code-block title="This sample code shows ONETOC2 to ONE C# Conversion" offSpacer="" %}}

{{< gist "aspose-com-gists" "1788c07710a98fd1bf9c1794a36ab8fe" "convert-onetoc2-to-one.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert ONETOC2 to ONE" sectionDescription="Check our live demos for [ONETOC2 to ONE conversion](https://products.aspose.app/note/conversion/onetoc2-to-one) with following benefits." >}}
