...
<p class="col-lg-10">Extrahujte obrázky ze souborů OneNotu</p>
...
<p class="col-lg-10">Výchozí písmo pro dokumenty Note</p>
...
<h2 class="h2title">Automatizace Microsoft Office OneNote – není potřeba</h2>

<p>Aspose.Note for Java je vytvořen pomocí spravovaného kódu, který pro práci se soubory OneNotu nevyžaduje instalaci sady Microsoft Office nebo Microsoft OneNote v počítači. Jedná se o dokonalou automatizační alternativu Microsoft OneNote z hlediska podporovaných funkcí, zabezpečení, stability, škálovatelnosti, rychlosti a ceny.</p>
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Note pro Java?" tabId="success-stories" >}}
