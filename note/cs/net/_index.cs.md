...
{{< blocks/products/pf/i18n/upper-banner h1="Rozhraní API pro zpracování dokumentů .NET OneNotu" h2="Vytvářejte, manipulujte a převádějte soubory OneNote do více formátů bez jakýchkoli závislostí na Microsoft OneNote." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/headers/aspose_note-for-net.svg" pfName="Aspose.Note" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/note/net" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Manipulujte s hypertextovými odkazy v textových a obrazových prvcích
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Tisk dokumentu OneNotu na výchozí tiskárně - C#
     </h3>
