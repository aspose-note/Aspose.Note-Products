...
{{< blocks/products/pf/i18n/upper-banner h1=".NET OneNote-Dokumentverarbeitungs-APIs" h2="Erstellen, bearbeiten und konvertieren Sie OneNote-Dateien in mehrere Formate ohne Microsoft OneNote-Abhängigkeiten." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/headers/aspose_note-for-net.svg" pfName="Aspose.Note" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/note/net" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Bearbeiten Sie mit Hyperlinks in Text- und Bildelementen
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
