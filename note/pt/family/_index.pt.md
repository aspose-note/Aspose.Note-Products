---
title: .NET e Java OneNote API | Processamento de documentos do OneNote 
weight: 10
url: /pt/family
description: Ler criar manipular salvar arquivos do Microsoft Office OneNote usando a biblioteca relevante em qualquer plataforma. Exporte documentos .one para formatos PDF BMP PNG JPEG GIF
---
...
{{< blocks/products/pf/product pfName="Aspose.Note for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg" productLink="/note/pt/net/" >}}
Destina-se a Windows Forms, ASP.NET, WPF, WCF ou qualquer tipo de aplicativo baseado em .NET Framework 2.0 ou posterior.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Note for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-java.svg" productLink="/note/pt/java/" >}}
...
{{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/note/" >}}
{{< blocks/products/pf/slr-element name="Código fonte" href="https://github.com/aspose-note?tab=repositories" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que a família de produtos Aspose.Note?" tabId="success-stories" >}}
