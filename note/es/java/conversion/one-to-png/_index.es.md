---
title: Convierta ONE a PNG a través de Java
description: Código de muestra para la conversión de ONE a PNG Java. Utilice el código de ejemplo API para la conversión de archivos por lotes ONE a PNG dentro de cualquier aplicación basada en Java. 
url: /es/java/conversion/one-to-png/
family: note
platformtag: java
feature: conversion
informat: ONE
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta ONE a PNG a través de Java" h2="Exporte OneNote<sup>&reg;</sup> ONE a imagen PNG dentro de aplicaciones basadas en Java sin depender de ningún otro software." >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Note para Java](https://products.aspose.com/note/java/) es una API para procesar, ver o convertir archivos de Microsoft OneNote a formatos de imagen PDF, JPG, PNG, PNG y TIFF. Es una API de aplicación independiente, fácil de usar y rápida y no necesita ningún software adicional. Admite extensiones .one y .onenote con conversión de alto rendimiento.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ONE a PNG" %}}
1. Cargue UN archivo con la clase Documento
2. Cree el objeto ImageSaveOptions con SaveFormat.Png como parámetro.
3. Llame al método Guardar con archivo de imagen PNG y guarde las opciones como parámetros.
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra cómo convertir ONE a una imagen PNG a través de Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir ONE a PNG" sectionDescription="[Convertir archivo de OneNote](https://products.aspose.app/note/conversion/onenote-to-png) ahora mismo visitando nuestro sitio web de demostraciones en vivo." >}}
