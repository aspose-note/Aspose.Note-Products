...
weight: 30
url: /sv/net/ 
description: C# VB.NET ASP.NET OneNote-bibliotek för att läsa skriv och redigera Microsoft OneNote-filer i .NET Windows-webbapplikationer eller tjänster. Skapa och exportera .one-filer till PDF BMP PNG JPEG GIF
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1=".NET OneNote Documents Processing API:er" h2="Skapa, manipulera och konvertera OneNote-filer till flera format utan några Microsoft OneNote-beroenden." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/note/headers/aspose_note-for-net.svg" pfName="Aspose.Note" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/note/net" >}}
...
<p>Aspose.Note för .NET är ett fristående OneNote-dokumentmanipulerings-API. Applikationer kan enkelt tillhandahålla funktionalitet som att läsa, konvertera, skapa, redigera och manipulera Microsoft OneNote-filer samt manipulera elementen i OneNote-böcker och sedan exportera till olika format.</p>

<p>Genom att använda API från Aspose.Note kan utvecklare ladda dokument, rendera text och bilder från OneNote-fil till flera format, navigera genom dokumentobjektmodellen, extrahera text från vilken del av en fil som helst och mycket mer.</p>
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Du kan med säkerhet använda Aspose.Note för .NET för att bygga vilken typ av 32-bitars eller 64-bitars .NET-applikation som helst." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Note for .NET [filformat som stöds](https://docs.aspose.com/note/net/supported-file-formats/)  listas nedan." >}}
<div class="diagram1 d2 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API:er för att manipulera OneNote-filer" src="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-net.svg"/>
  <header>
   Aspose.Note
  </header>
  <footer>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Avancerade .NET OneNote API-funktioner
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Utvecklare kan enkelt ladda
     <strong>
      ONE
     </strong>
     filer och rendera dem i olika bildformat
     <strong>
      TIFF
     </strong>
     ,
     ...
     . Dessutom stöder API:et konvertering av OneNote-dokument till PDF-format för enkel delning.
    </p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Note för .NET gör det möjligt att komma åt och läsa egenskaperna för olika objekt som dokument, sidor, text och bildelement genom dess objektmodell. Dessutom gör biblioteket det möjligt för användare att komma åt OneNote-bokens bildegenskaper, inklusive filnamn, bredd, höjd, filtillägg, datum för senaste ändring, etc.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
{{< blocks/products/pf/slr-element name="Källkod" href="https://github.com/aspose-note/Aspose.Note-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API-referenser" href="https://apireference.aspose.com/note/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Note för .NET?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Note " description="Aspose.Note erbjuder individuella OneNote API:er för andra populära utvecklingsmiljöer enligt listan nedan:" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/note/sv/java/" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/note/aspose_note-for-java.svg" sdkName="Java" >}}
